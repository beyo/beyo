...
Options
  - path                      the plugins' root path relative to beyo.appRoot
      ...
      try {
        ...
        if (pluginName in pluginsMap) {
          if (pluginsMap[pluginName] === false) {
            ...
            throw PluginsLoaderException('Plugin map value must be a string: ' + String(pluginsMap[pluginName]), eventData);
          } else {
