...
function loadController(beyo, options, controllerPath) {
  ...
  return Promise.resolve( beyo.require(path.join(beyo.rootPath, options.path, controllerPath)) ).then(function (controllerInit) {
        return controllerInit.call(controllerData.context, beyo);
