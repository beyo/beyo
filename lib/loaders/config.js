...
module.exports = function * configLoader(beyo, options) {
  ...
  if (options === undefined) {
    throw ConfigurationException('No options specified');
  } else if (options === null || options.__proto__.constructor !== Object) {
    throw ConfigurationException('Invalid options value: ' + String(options));
  } else if (!('path' in options)) {
    throw ConfigurationException('Config path not specified');
  } else if (typeof options.path !== 'string') {
    throw ConfigurationException('Invalid path value: ' + String(options.path));
  } else if ('moduleName' in options && typeof options.moduleName !== 'string') {
    throw ConfigurationException('Invalid module name: ' + String(options.moduleName));
  }
