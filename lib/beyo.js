...
function applicationRequire(beyo, options) {
  try {
    return Promise.resolve(require(beyo.rootPath)).then(function (appInitModule) {
      return appInitModule.call(options, beyo);
    ...
    throw InitializationException('Could not load application in init module', { path: beyo.rootPath, error: e });
  }
}
