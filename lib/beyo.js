...
function * initApplication(beyo, options) {
  ...
  yield initPlugins(beyo, options);
...
function * initHMVC(beyo, options) {
  ...
  function _getValue(key, property) {
    ...
    parts = key.match(MODULE_KEY_REGEX);
    ...
    if (parts[1]) {
      ...
      value = module && module[property][parts[2]];
    } else {
  ...
  Object.defineProperty(beyo, 'models', {
    configurable: false,
    enumerable: true,
    writable: false,
  ...
  Object.defineProperty(beyo, 'services', {
    configurable: false,
    enumerable: true,
    writable: false,
    value: function getModel(key) {
...
function * applicationRequire(beyo, options) {
  ...
  var module = yield appInitModule.call(options, beyo);
